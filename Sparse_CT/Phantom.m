...
disp('####Sparse Tomographic Reconstruction of the Shepp Logan Phantom####');
...
title("Reconstructed image from the feedforward neural network")

figure
imshow(Reconstruction_inter,[])
title("Reconstructed image from the cubic spline interpolation")
